...
fun StartScreen(modifier: Modifier = Modifier) {
        ...
        Card(
            ...
            Column {
                Image(painter = painterResource(id = R.drawable.sumedang), modifier = Modifier.padding(vertical = 30.dp).align(Alignment.CenterHorizontally).size(150.dp).absoluteOffset(y = 50.dp), contentDescription = null)
                Column(Modifier.padding(dimensionResource(id = R.dimen.padding_medium))) {
                    Text(
                        text = stringResource(id = R.string.sumedang_title),
                        style = MaterialTheme.typography.titleLarge,
                        modifier = Modifier.padding(bottom = dimensionResource(id = R.dimen.padding_small))
                    )
                    Text(
                        text = stringResource(id = R.string.sumedang_description),
